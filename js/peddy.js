        ...
        card.innerHTML = `
            ...
            <div class="card-body p-0 w-11/12 mx-auto">
                ...
                <div class="flex gap-2">
                    ...
                    <p class="text-[#131313B3]">Birth: ${new Date(pet.date_of_birth).getFullYear() || "Not available"}</p>
                </div>
                <div class="flex gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="size-6">
                ...
                <div class="modal-box w-11/12 mx-auto p-10">
                    ...
                    <div class="grid grid-cols-2 pt-4 gap-4">
                        ...
                        <div class="flex gap-2">
                            ...
                            <p class="text-[#131313B3]">Birth: ${new Date(petData.date_of_birth).getFullYear() || "Not available"}</p>
                        </div>
                        <div class="flex gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="size-6">
                        ...
                        <div class="flex gap-2">
                            ...
                            <p class="text-[#131313B3]">Vaccinated status: ${petData.vaccinated_status || "Not available"}</p>
                        </div>
                    </div>
                    ...
                    <div class="modal-action">
                        <form method="dialog" class="w-full">
                            <button class="btn bg-[#0E7A8133] text-[#0E7A81] font-extrabold w-full">Cancel</button>
                        </form>
                    </div>
                </div>
    `;
